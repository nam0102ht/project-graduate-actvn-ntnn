...
public final class ApiBalanceGrpc {
  ...
  public static final io.grpc.MethodDescriptor<com.ntnn.grpc.balance.Request,
      com.ntnn.grpc.balance.Response> METHOD_WITHDRAWAL =
      io.grpc.MethodDescriptor.<com.ntnn.grpc.balance.Request, com.ntnn.grpc.balance.Response>newBuilder()
          .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
          .setFullMethodName(generateFullMethodName(
              "apiBalance.ApiBalance", "withdrawal"))
          .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              com.ntnn.grpc.balance.Request.getDefaultInstance()))
          .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              com.ntnn.grpc.balance.Response.getDefaultInstance()))
          .build();
  ...
  public static abstract class ApiBalanceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void withdrawal(com.ntnn.grpc.balance.Request request,
        io.grpc.stub.StreamObserver<com.ntnn.grpc.balance.Response> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.ntnn.grpc.balance.Request,
                com.ntnn.grpc.balance.Response>(
  ...
  public static final class ApiBalanceBlockingStub extends io.grpc.stub.AbstractStub<ApiBalanceBlockingStub> {
    ...
    /**
     */
    public com.ntnn.grpc.balance.Response withdrawal(com.ntnn.grpc.balance.Request request) {
  ...
  public static final class ApiBalanceFutureStub extends io.grpc.stub.AbstractStub<ApiBalanceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.ntnn.grpc.balance.Response> withdrawal(
        com.ntnn.grpc.balance.Request request) {
  ...
  public static abstract class ApiBalanceVertxImplBase implements io.grpc.BindableService {
     ...
     */
    public void withdrawal(com.ntnn.grpc.balance.Request request,
        io.vertx.core.Future<com.ntnn.grpc.balance.Response> response) {
  ...
  public static final class ApiBalanceVertxStub extends io.grpc.stub.AbstractStub<ApiBalanceVertxStub> {
     ...
     */
    public void withdrawal(com.ntnn.grpc.balance.Request request,
        io.vertx.core.Handler<io.vertx.core.AsyncResult<com.ntnn.grpc.balance.Response>> response) {
      asyncUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_WITHDRAWAL:
          serviceImpl.withdrawal((com.ntnn.grpc.balance.Request) request,
              (io.grpc.stub.StreamObserver<com.ntnn.grpc.balance.Response>) responseObserver);
          break;
        default:
  ...
  private static final class VertxMethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_WITHDRAWAL:
          serviceImpl.withdrawal((com.ntnn.grpc.balance.Request) request,
              (io.vertx.core.Future<com.ntnn.grpc.balance.Response>) io.vertx.core.Future.<com.ntnn.grpc.balance.Response>future().setHandler(ar -> {
                if (ar.succeeded()) {
                  ((io.grpc.stub.StreamObserver<com.ntnn.grpc.balance.Response>) responseObserver).onNext(ar.result());
  ...
  private static final class ApiBalanceDescriptorSupplier implements io.grpc.protobuf.ProtoFileDescriptorSupplier {
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.ntnn.grpc.balance.ApiBalanceProto.getDescriptor();
    }
  }
