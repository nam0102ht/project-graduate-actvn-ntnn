...
public final class AuthApiGrpc {
  ...
  public static final io.grpc.MethodDescriptor<com.ntnn.grpc.auth.Request,
      com.ntnn.grpc.auth.Response> METHOD_AUTHENTICATE =
      io.grpc.MethodDescriptor.<com.ntnn.grpc.auth.Request, com.ntnn.grpc.auth.Response>newBuilder()
          .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
          .setFullMethodName(generateFullMethodName(
              "authApi.AuthApi", "authenticate"))
          .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              com.ntnn.grpc.auth.Request.getDefaultInstance()))
          .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              com.ntnn.grpc.auth.Response.getDefaultInstance()))
          .build();
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final io.grpc.MethodDescriptor<com.ntnn.grpc.auth.Request,
      com.ntnn.grpc.auth.Response> METHOD_RETRIEVE =
      io.grpc.MethodDescriptor.<com.ntnn.grpc.auth.Request, com.ntnn.grpc.auth.Response>newBuilder()
          .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
          .setFullMethodName(generateFullMethodName(
  ...
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final io.grpc.MethodDescriptor<com.ntnn.grpc.auth.Request,
      com.ntnn.grpc.auth.Response> METHOD_GET_PROFILE =
      io.grpc.MethodDescriptor.<com.ntnn.grpc.auth.Request, com.ntnn.grpc.auth.Response>newBuilder()
          .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
          .setFullMethodName(generateFullMethodName(
  ...
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final io.grpc.MethodDescriptor<com.ntnn.grpc.auth.Request,
      com.ntnn.grpc.auth.Response> METHOD_RESET_PIN =
      io.grpc.MethodDescriptor.<com.ntnn.grpc.auth.Request, com.ntnn.grpc.auth.Response>newBuilder()
          .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
          .setFullMethodName(generateFullMethodName(
  ...
  public static abstract class AuthApiImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void authenticate(com.ntnn.grpc.auth.Request request,
        io.grpc.stub.StreamObserver<com.ntnn.grpc.auth.Response> responseObserver) {
      asyncUnimplementedUnaryCall(METHOD_AUTHENTICATE, responseObserver);
    }

    /**
     */
    public void retrieve(com.ntnn.grpc.auth.Request request,
        io.grpc.stub.StreamObserver<com.ntnn.grpc.auth.Response> responseObserver) {
    ...
    /**
     */
    public void getProfile(com.ntnn.grpc.auth.Request request,
        io.grpc.stub.StreamObserver<com.ntnn.grpc.auth.Response> responseObserver) {
    ...
    /**
     */
    public void resetPin(com.ntnn.grpc.auth.Request request,
        io.grpc.stub.StreamObserver<com.ntnn.grpc.auth.Response> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.ntnn.grpc.auth.Request,
                com.ntnn.grpc.auth.Response>(
  ...
  public static final class AuthApiBlockingStub extends io.grpc.stub.AbstractStub<AuthApiBlockingStub> {
    ...
    /**
     */
    public com.ntnn.grpc.auth.Response authenticate(com.ntnn.grpc.auth.Request request) {
    ...
    /**
     */
    public com.ntnn.grpc.auth.Response retrieve(com.ntnn.grpc.auth.Request request) {
      return blockingUnaryCall(
    ...
    /**
     */
    public com.ntnn.grpc.auth.Response getProfile(com.ntnn.grpc.auth.Request request) {
      return blockingUnaryCall(
    ...
    /**
     */
    public com.ntnn.grpc.auth.Response resetPin(com.ntnn.grpc.auth.Request request) {
      return blockingUnaryCall(
  ...
  public static final class AuthApiFutureStub extends io.grpc.stub.AbstractStub<AuthApiFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.ntnn.grpc.auth.Response> authenticate(
        com.ntnn.grpc.auth.Request request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.ntnn.grpc.auth.Response> retrieve(
        com.ntnn.grpc.auth.Request request) {
      return futureUnaryCall(
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.ntnn.grpc.auth.Response> getProfile(
        com.ntnn.grpc.auth.Request request) {
      return futureUnaryCall(
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.ntnn.grpc.auth.Response> resetPin(
        com.ntnn.grpc.auth.Request request) {
      return futureUnaryCall(
  ...
  public static abstract class AuthApiVertxImplBase implements io.grpc.BindableService {
     ...
     */
    public void authenticate(com.ntnn.grpc.auth.Request request,
        io.vertx.core.Future<com.ntnn.grpc.auth.Response> response) {
  ...
  public static final class AuthApiVertxStub extends io.grpc.stub.AbstractStub<AuthApiVertxStub> {
     ...
     */
    public void authenticate(com.ntnn.grpc.auth.Request request,
        io.vertx.core.Handler<io.vertx.core.AsyncResult<com.ntnn.grpc.auth.Response>> response) {
      asyncUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_AUTHENTICATE:
          serviceImpl.authenticate((com.ntnn.grpc.auth.Request) request,
              (io.grpc.stub.StreamObserver<com.ntnn.grpc.auth.Response>) responseObserver);
          break;
        case METHODID_RETRIEVE:
          serviceImpl.retrieve((com.ntnn.grpc.auth.Request) request,
              (io.grpc.stub.StreamObserver<com.ntnn.grpc.auth.Response>) responseObserver);
          break;
        case METHODID_GET_PROFILE:
          serviceImpl.getProfile((com.ntnn.grpc.auth.Request) request,
              (io.grpc.stub.StreamObserver<com.ntnn.grpc.auth.Response>) responseObserver);
          break;
        case METHODID_RESET_PIN:
          serviceImpl.resetPin((com.ntnn.grpc.auth.Request) request,
              (io.grpc.stub.StreamObserver<com.ntnn.grpc.auth.Response>) responseObserver);
          break;
        default:
  ...
  private static final class VertxMethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_AUTHENTICATE:
          serviceImpl.authenticate((com.ntnn.grpc.auth.Request) request,
              (io.vertx.core.Future<com.ntnn.grpc.auth.Response>) io.vertx.core.Future.<com.ntnn.grpc.auth.Response>future().setHandler(ar -> {
                if (ar.succeeded()) {
                  ((io.grpc.stub.StreamObserver<com.ntnn.grpc.auth.Response>) responseObserver).onNext(ar.result());
  ...
  private static final class AuthApiDescriptorSupplier implements io.grpc.protobuf.ProtoFileDescriptorSupplier {
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.ntnn.grpc.auth.AuthApiProto.getDescriptor();
    }
  }
